  ...
  ---
<p><a href="https://hub.docker.com/r/reaitten/botbotupdates"> <img src="https://img.shields.io/docker/pulls/reaitten/botbotupdates?style=for-the-badge" width="150""/></a> <a href="https://hub.docker.com/layers/reaitten/botbotupdates/latest/images/sha256-2f8b28fa0b7998fcc917589e211c40d4621ac0eb4181cb96a4d18bfcb74e368c?context=explore"> <img src="https://img.shields.io/docker/image-size/reaitten/tgtlg/latest?style=for-the-badge" width="150""/></a> <a href="https://github.com/reaitten/tgtlg"> <img src="https://img.shields.io/github/repo-size/reaitten/botbotupdates?style=for-the-badge" width="150"/></a> <a href="https://github.com/reaitten/botbotupdates/blob/main/LICENSE"> <img src="https://img.shields.io/github/license/reaitten/botbotupdates?style=for-the-badge" width="150"/></a></p> 
  
  ![GitHub Repo stars](https://img.shields.io/github/stars/reaitten/botbotupdates?style=social) ![GitHub forks](https://img.shields.io/github/forks/reaitten/botbotupdates?style=social)
  ---
  # Table of Contents
...
- [To-Do](#to-do)
  ...
  * [Credits](#credits-and-thanks-to)
  ...
  <p><a href="https://heroku.com/deploy?template=https://github.com/reaitten/botbotupdates"> <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="200""/></a></p>

  ## Deploy on VPS

  - Clone this repo:
  ```
  git clone -b main https://github.com/reaitten/botbotupdates botbotupdates
  cd botbotupdates
  ```
  ...
  If you need more explanation about any variable then read [app.json](https://github.com/reaitten/botbotupdates/blob/deploy-main/app.json)
  ...
  ```
  git clone -b 4forks https://github.com/reaitten/botbotupdates
...
You can add a custom name as it's prefix to the file. Example: if gk.txt uploaded will be what you add in CUSTOM_FILE_NAME + gk.txt
  ...
  * send any one of the available commands, as a reply to a valid link/magnet/torrent.
  ...
  ## Credits
  - [botbotupdates](https://github.com/botbotupdates/TorrentLeech-Gdrive)
